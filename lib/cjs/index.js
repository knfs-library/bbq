 ...
 *
 * @typedef {{size: number, expire: number, secretKey: string, updateMetaTime: number, log:bool, limit: number, rebroadcastTime: number}} OptionQueueDefaultType
 * @typedef {{path: string, queueConfig: OptionQueueDefaultType, log: bool}} ConfigType
 *
...
class Dispatcher {
	...
	async createQueue(name, options = {
		...
		updateMetaTime: queueDefault.updateMetaTime,
		rebroadcastTime: queueDefault.rebroadcastTime,
		log: false
	}) {
